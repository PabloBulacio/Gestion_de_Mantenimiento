...
bool Fecha::cargar(int x, int y){
    ...
    cin>>dia;
     while(!(dia>0 && dia<=31)){
            msj("**NO CORRESPONDE A UN DÍA VÁLIDO**", rlutil::WHITE, rlutil::RED);
            setColor(WHITE);
            locate(x,++y);
            cout << "Día: ";
            cin>>dia;
    ...
    cin >> mes;
    while(!(mes>0 && mes<=12)){
            msj("**NO CORRESPONDE A UN MES VÁLIDO**", rlutil::WHITE, rlutil::RED);
            setColor(WHITE);
            locate(x,++y);
            cout << "Mes: ";
            cin>>mes;
    ...
    while(!(anio>=1900 && anio<=2021)){
            msj("**NO CORRESPONDE A UN AÑO VÁLIDO**", rlutil::WHITE, rlutil::RED);
            setColor(WHITE);
            locate(x,++y);
            cout << "Año: ";
            cin>>anio;
...
int Fecha::cantAniosHastaHoy(int dia, int mes, int anio){
